...
const highlightColors = {
  cyan: {
    ...
    badge: 'bg-cyan-400/10 text-cyan-500 dark:text-cyan-400 border border-cyan-400/20',
    metric: 'bg-cyan-50 dark:bg-cyan-400/8 text-cyan-700 dark:text-cyan-300',
    accent: 'text-cyan-400',
    btn: 'bg-cyan-500 hover:bg-cyan-400',
  },
  violet: {
    border: 'hover:border-violet-400/40',
    badge: 'bg-violet-400/10 text-violet-500 dark:text-violet-400 border border-violet-400/20',
    metric: 'bg-violet-50 dark:bg-violet-400/8 text-violet-700 dark:text-violet-300',
    accent: 'text-violet-400',
    btn: 'bg-violet-500 hover:bg-violet-400',
  },
  blue: {
    border: 'hover:border-blue-400/40',
    badge: 'bg-blue-400/10 text-blue-500 dark:text-blue-400 border border-blue-400/20',
    metric: 'bg-blue-50 dark:bg-blue-400/8 text-blue-700 dark:text-blue-300',
    accent: 'text-blue-400',
    btn: 'bg-blue-500 hover:bg-blue-400',
  },
  pink: {
    border: 'hover:border-pink-400/40',
    badge: 'bg-pink-400/10 text-pink-500 dark:text-pink-400 border border-pink-400/20',
    metric: 'bg-pink-50 dark:bg-pink-400/8 text-pink-700 dark:text-pink-300',
